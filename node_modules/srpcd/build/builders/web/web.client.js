...
exports.webClientGenerator = void 0;
const lib_1 = require("../../lib");
const helpers_1 = require("../helpers");
function webClientGenerator({ output, target, semantic }) {
    return __awaiter(this, void 0, void 0, function* () {
        const { map, proto, proto_json } = yield semantic.generateProto();
        const { client } = yield semantic.generateWebClient();
        const project_dir = new lib_1.ProjectDirectory({
            dir: output
        });
...
exports.webClientGenerator = webClientGenerator;
